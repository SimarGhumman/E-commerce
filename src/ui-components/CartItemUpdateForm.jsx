...
export default function CartItemUpdateForm(props) {
  ...
  const resetStateValues = () => {
    const cleanValues = cartItemRecord
      ? { ...initialValues, ...cartItemRecord, Product, userID }
      : initialValues;
  ...
  React.useEffect(() => {
    ...
    queryData();
  }, [idProp, cartItemModelProp]);
  React.useEffect(resetStateValues, [cartItemRecord, Product, userID]);
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          const modelFieldsToSave = {
            cartItemProductId: modelFields?.Product?.id ?? null,
    ...
    >
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || cartItemModelProp)}
