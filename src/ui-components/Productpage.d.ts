...
export declare type ProductpageOverridesProps = {
    Productpage?: PrimitiveOverrideProps<ViewProps>;
    ...
    "Grown in San Juan Capistrano, CA"?: PrimitiveOverrideProps<TextProps>;
    ...
    "Grown in Huntington Beach, CA"?: PrimitiveOverrideProps<TextProps>;
    "noonbrew-ziCb4_EKmak-unsplash"?: PrimitiveOverrideProps<ImageProps>;
} & EscapeHatchProps;
export declare type ProductpageProps = React.PropsWithChildren<Partial<ViewProps> & {
    overrides?: ProductpageOverridesProps | undefined | null;
}>;
